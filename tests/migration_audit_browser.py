...
check('classic execution order and no duplicate scripts', '''(()=>{
 ...
 scripts.map(s=>new URL(s.src).pathname.split('/').pop()).join(',')==='core.js,lang-detect.js,tts.js,selection.js,learning-stats.js,navigation.js,pdf-zoom-pan.js,ui-tooltip.js,translation.js,grammar-svo.js,ai-client.js,practice-session.js,practice-worksheet.js,dictation.js,pdf-ink.js,pdf-crop.js,pdf-outline.js,pdf-thumbnails.js,pdf-continuous.js,pdf-render.js,formats.js,onboarding.js,quick-wheel.js,main.js,pwa-lifecycle.js';})()''')
