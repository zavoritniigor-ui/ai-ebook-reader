...
check('classic execution order and no duplicate scripts', '''(()=>{
 ...
 scripts.map(s=>new URL(s.src).pathname.split('/').pop()).join(',')==='core.js,lang-detect.js,tts.js,selection.js,learning-stats.js,navigation.js,pdf-zoom-pan.js,ui-tooltip.js,translation.js,grammar-svo.js,ai-client.js,dictation.js,pdf-ink.js,pdf-crop.js,pdf-render.js,formats.js,onboarding.js,quick-wheel.js,main.js,pwa-lifecycle.js';})()''')
