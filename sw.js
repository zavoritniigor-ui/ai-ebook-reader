...
const CACHE_NAME = 'ai-reader-shell-2238a02936e5';
...
const APP_SHELL = [
    ...
    './icons/icon-192.png',
    './icons/icon-512.png',
    './js/core.js?v=0294f01107c0',
    './js/lang-detect.js?v=21625d365df7',
    './js/ai-client.js?v=82020067e03c',
    './js/selection.js?v=887b5c4cb5a3',
    './js/learning-stats.js?v=67246f255f39',
    './js/pdf-render.js?v=64ef9f00575d',
    './js/tts.js?v=d0219e4d74e8',
    './js/translation.js?v=3a8c557ecf71',
    './js/grammar-adjectives.js?v=a33cd547f4dd',
    './js/grammar-rules.js?v=70b8e8d09740',
    './js/grammar-analysis-schema.js?v=6f547f6893a5',
    './js/grammar-adjectives-analyzer.js?v=fe0515defc86',
    './js/grammar-svo.js?v=1e2cc926855e',
    './js/grammar-adjectives-ui.js?v=607df2983904',
    './js/practice-session.js?v=33a9e03c4ee0',
    './js/practice-worksheet.js?v=acbcb2afec03',
    './js/navigation.js?v=cd49774de655',
    './js/formats.js?v=590fbe43ebc9',
    './js/pdf-zoom-pan.js?v=998e78d2c132',
    './js/pdf-ink.js?v=cdef18c51883',
    './js/pdf-crop.js?v=331b25dbd978',
    './js/dictation.js?v=cd46e7d595c8',
    './js/ui-tooltip.js?v=1985b4724fd6',
    './js/onboarding.js?v=30c9f576755e',
    './js/quick-wheel.js?v=9908358a1e32',
    './js/main.js?v=b1568be2db5e',
