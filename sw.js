...
const CACHE_NAME = 'ai-reader-shell-bebf4aa31be4';
...
const APP_SHELL = [
    ...
    './js/pdf-render.js?v=d63388729c7d',
    ...
    './js/navigation.js?v=acb789e5ea0a',
    './js/formats.js?v=590fbe43ebc9',
    './js/pdf-zoom-pan.js?v=aa9200af9ce2',
    './js/pdf-ink.js?v=9c7619668e39',
    './js/pdf-crop.js?v=e4a75ce89d14',
    './js/pdf-outline.js?v=0002ad18f36c',
    './js/pdf-thumbnails.js?v=dcfce562cb0d',
    './js/pdf-continuous.js?v=5dcf0cf06356',
