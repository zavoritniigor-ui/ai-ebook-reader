...
const CACHE_NAME = 'ai-reader-shell-4179a074db50';
...
const APP_SHELL = [
    ...
    './js/lang-detect.js?v=6da5d4bbd5dc',
    './js/ai-client.js?v=a7a5f853ab94',
    './js/selection.js?v=649429fd17c4',
    './js/pdf-render.js?v=7d5c650a8f84',
    './js/tts.js?v=1f9cc32ecc47',
    './js/translation.js?v=59e0973c2adc',
    './js/grammar-svo.js?v=4961aebc5067',
    './js/navigation.js?v=310792008e41',
