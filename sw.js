...
const CACHE_NAME = 'ai-reader-shell-39f0b38c90d2';
...
const APP_SHELL = [
    ...
    './icons/icon-192.png',
    './icons/icon-512.png',
    './js/core.js?v=a75d9901633f',
    './js/lang-detect.js?v=21625d365df7',
    './js/ai-client.js?v=e0ffbb63b46c',
    ...
    './js/grammar-svo.js?v=f9404d587aa3',
    './js/practice-session.js?v=7c1a4d63cda1',
    './js/practice-worksheet.js?v=83e1221cf795',
    './js/navigation.js?v=35e62f613b99',
    './js/formats.js?v=590fbe43ebc9',
    './js/pdf-zoom-pan.js?v=f71892ac0dc5',
    ...
    './js/pdf-continuous.js?v=4f268765b95d',
