...
const CACHE_NAME = 'ai-reader-shell-0cf2791b792b';
...
const APP_SHELL = [
    ...
    './icons/icon-192.png',
    './icons/icon-512.png',
    './js/core.js?v=5fe4731551b7',
    './js/lang-detect.js?v=4c411a17b2b8',
    './js/ai-client.js?v=1c1c4277c83b',
    ...
    './js/grammar-svo.js?v=16c62adf35af',
    './js/practice-session.js?v=1c098c1d5b43',
