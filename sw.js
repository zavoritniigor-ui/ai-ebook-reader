...
const CACHE_NAME = 'ai-reader-shell-271dfef6506d';
...
const APP_SHELL = [
    ...
    './icons/icon-192.png',
    './icons/icon-512.png',
    './js/core.js?v=3b6266793da2',
    './js/lang-detect.js?v=5ce1fc05ac06',
    './js/ai-client.js?v=a7a5f853ab94',
    './js/selection.js?v=831ccbaac0d9',
    './js/pdf-render.js?v=7d5c650a8f84',
    './js/tts.js?v=acafd96cc392',
    './js/translation.js?v=b73b443efc69',
    './js/grammar-svo.js?v=77341cc54170',
    ...
    './js/main.js?v=006eba871c69',
    './js/google-classroom.js?v=5fbaaed33089',
    './js/pwa-lifecycle.js?v=7070c58598f0',
