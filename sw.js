...
const CACHE_NAME = 'ai-reader-shell-09f8d0196896';
...
const APP_SHELL = [
    ...
    './icons/icon-192.png',
    './icons/icon-512.png',
    './js/core.js?v=594dfd56ec2b',
    './js/lang-detect.js?v=f87bb7fd3739',
    './js/ai-client.js?v=e0ffbb63b46c',
    './js/selection.js?v=a61bbe144ee1',
    ...
    './js/grammar-svo.js?v=e345445ae352',
