...
const CACHE_NAME = 'ai-reader-shell-a894e59d78e3';
...
const APP_SHELL = [
    ...
    './icons/icon-192.png',
    './icons/icon-512.png',
    './js/core.js?v=964583d9acd9',
    './js/lang-detect.js?v=4c411a17b2b8',
    './js/ai-client.js?v=819c861727a2',
    './js/selection.js?v=f3377d74be72',
    './js/learning-stats.js?v=38a697ac8915',
    './js/pdf-render.js?v=f7f068dd2502',
    './js/tts.js?v=d0219e4d74e8',
    './js/translation.js?v=3a8c557ecf71',
    './js/grammar-svo.js?v=493772cd3db1',
    './js/practice-session.js?v=2d160b51d668',
    './js/practice-worksheet.js?v=4bd53811667e',
    './js/navigation.js?v=35e62f613b99',
    './js/formats.js?v=590fbe43ebc9',
    './js/pdf-zoom-pan.js?v=4c15a4acf89a',
    './js/pdf-ink.js?v=9c7619668e39',
    './js/pdf-crop.js?v=e4a75ce89d14',
    './js/pdf-outline.js?v=54df75ee8ef2',
    './js/pdf-thumbnails.js?v=ca9551e0f416',
    './js/pdf-continuous.js?v=52e0ec07166e',
    './js/dictation.js?v=cd46e7d595c8',
    './js/ui-tooltip.js?v=1985b4724fd6',
    './js/onboarding.js?v=30c9f576755e',
    './js/quick-wheel.js?v=4be0c2aad933',
    './js/main.js?v=fb7e1a9c2c8d',
