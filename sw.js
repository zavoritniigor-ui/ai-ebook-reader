...
const CACHE_NAME = 'ai-reader-shell-b376ca45aa88';
...
const APP_SHELL = [
    ...
    './js/grammar-svo.js?v=784efec46bf2',
    './js/practice-session.js?v=8defb3730d6e',
    './js/practice-worksheet.js?v=1ea98fd2fc64',
