...
const CACHE_NAME = 'ai-reader-shell-c15070afb308';
...
const APP_SHELL = [
    ...
    './js/pdf-zoom-pan.js?v=e84f1d935691',
    './js/pdf-ink.js?v=9c7619668e39',
    './js/pdf-crop.js?v=e4a75ce89d14',
    './js/pdf-outline.js?v=1865bd2eb877',
    './js/pdf-thumbnails.js?v=ca9551e0f416',
    './js/pdf-continuous.js?v=d3ed6c41bd97',
