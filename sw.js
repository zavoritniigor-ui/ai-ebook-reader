...
const CACHE_NAME = 'ai-reader-shell-0e7b13f5ed5e';
...
const APP_SHELL = [
    ...
    './js/pdf-render.js?v=62747661943d',
    ...
    './js/navigation.js?v=8ca25ec02d0b',
    './js/formats.js?v=590fbe43ebc9',
    './js/pdf-zoom-pan.js?v=aa9200af9ce2',
    './js/pdf-ink.js?v=9c7619668e39',
    './js/pdf-crop.js?v=e4a75ce89d14',
    './js/pdf-outline.js?v=182374b75727',
    './js/pdf-thumbnails.js?v=abcb9d03700f',
    './js/pdf-continuous.js?v=58007f3490b1',
