...
const CACHE_NAME = 'ai-reader-shell-33eaccccc057';
...
const APP_SHELL = [
    ...
    './icons/icon-192.png',
    './icons/icon-512.png',
    './js/core.js?v=713c7c062ace',
    './js/lang-detect.js?v=4c411a17b2b8',
    './js/ai-client.js?v=dbdff37a51aa',
    './js/selection.js?v=d6ecc9f25df0',
    './js/learning-stats.js?v=38a697ac8915',
    './js/pdf-render.js?v=7bc44e26dd09',
    './js/tts.js?v=a17baf6e57dd',
    './js/translation.js?v=c5b1ef982d4f',
    './js/grammar-svo.js?v=3f8b0d75a466',
    './js/practice-session.js?v=ca3e5f0617db',
    './js/practice-worksheet.js?v=9b3d4f232932',
    './js/navigation.js?v=f9b3e52acfc7',
    './js/formats.js?v=590fbe43ebc9',
    './js/pdf-zoom-pan.js?v=92884b71c1e4',
    './js/pdf-ink.js?v=9c7619668e39',
    './js/pdf-crop.js?v=68110ae78d3f',
    './js/pdf-outline.js?v=97d934db97c6',
    './js/pdf-thumbnails.js?v=8bb6dae47df9',
    './js/pdf-continuous.js?v=ee42c36e7287',
    './js/dictation.js?v=2251308802f9',
    './js/ui-tooltip.js?v=784171a5a724',
    './js/onboarding.js?v=30c9f576755e',
    './js/quick-wheel.js?v=3176ba147224',
    './js/main.js?v=7c3d5edab80c',
