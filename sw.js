...
const CACHE_NAME = 'ai-reader-shell-5b4c3f505951';
...
const APP_SHELL = [
    ...
    './js/selection.js?v=78c3adebbe98',
    './js/learning-stats.js?v=4e7f7b42d0bb',
    './js/pdf-render.js?v=7cd1c82368db',
    './js/tts.js?v=64539ee7a830',
    './js/translation.js?v=59e0973c2adc',
    './js/grammar-svo.js?v=30495a642fb3',
